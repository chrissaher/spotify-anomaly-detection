!function() {
    window.Dashboard=window.Dashboard|| {}, Dashboard.Helpers=Dashboard.Helpers|| {}, Dashboard.Helpers.isDefaultSidebar=function() {
        var a=document.querySelector("body"), e=!(a.classList.contains("sidebar-big-icons")||a.classList.contains("sidebar-slim"));
        return e
    }
    ,
    ...
    ,
    Dashboard.Helpers.setAttributeChangeObserver=function(a,
    e) {
    ...
    ,
    Dashboard.Helpers.setFixedRelativeToElement=function(a,
    e,
    n) {
        a=a||$(), e=e||$();
        ...
        if(n) {
            ...
            a.css( {
                left: "auto", right: r+"px"
            }
            )
        }
        else t="left: {left}px; right: auto".replace("{left}",
        i.left.toString()),
        a.css("cssText",
        t)
    }
    ,
    Dashboard.Helpers.elementExists=function(a,
    e) {
    ...
    Dashboard.Helpers.DeviceMediaQueries= {
        SCREEN_XS: "(max-width: 767px)", SCREEN_SM: "(min-width: 768px)", SCREEN_MD: "(min-width: 992px)", SCREEN_LG: "(min-width: 1200px)"
    }
    ,
    Dashboard.Helpers.Colors= {
        grayBase: "#000", grayDarker: "#262626", grayDark: "#2d2d2d", gray: "#383838", grayLight: "#444444", grayLighter: "#5c5c5c", brandWhite: "white", brandPrimary: "#2c97de", brandSuccess: "#84b547", brandInfo: "#2dbda8", brandWarning: "#e76d3b", brandDanger: "#cc3e4a", brandCerulean: "#00A3E3", brandCuriousBlue: "#2986c7", brandEndaveour: "#0055a3", brandMinsk: "#362d88", brandEminence: "#742787", brandVioletEggplant: "#aa1985", brandMintGreen: "#72ff96", brandAquamarine: "#62ffe0", brandMalibu: "#6abfff", brandDodgerBlue: "#5e6cff", brandHeliotrope: "#a26bff", brandPerfume: "#f57ffe"
    }
}
(),
function() {
    ...
    Dashboard.LayoutControl= {
        $content: $(".content"), $footer: $("footer"), $navBar: $(".navigation .navbar"), $sideBar: $(".navigation .sidebar"), $window: $(window), setContentMinHeight: function(a) {
            a=a||0;
            var e=this.$window.height(), n=this.$sideBar.outerHeight(!0)+a;
            if(e>=n) {
                var t=this.$footer.is(":visible")&&!Dashboard.Helpers.isFixedFooter()?this.$footer.height(): 0, i=this.$navBar.is(":visible")?this.$navBar.height():0, r="calc(100vh - {navfootHeight}px)".replace("{navfootHeight}", t+i);
                this.$content.css("minHeight", r)
            }
            else this.$content.css("minHeight",
            n)
        }
        ,
        initLayoutChangeEventEmitter:function() {
            var n=document.querySelector("body"), t=document.querySelector(".content > .container, .content > .container-fluid"), i=new MutationObserver(function(i) {
        ...
        setFixedSidebarsRelativeToContent:function() {
            var a=Dashboard.Helpers.isBoxedLayout(), e=Dashboard.Helpers.isRTL(), n=$(".sidebar"), t=$(".right-sidebar");
            if(a) {
                var i=$(".main-wrap"), r=Dashboard.Helpers.isFixedSidebar();
                r?Dashboard.Helpers.setFixedRelativeToElement(n, i, e):n.css( {
                    left: "", right: ""
                }
                ),
                Dashboard.Helpers.setFixedRelativeToElement(t,
                i,
                !e)
            }
            else n.add(t).css( {
        ...
        setSidebarsStickyness:function() {
            var a=$(".sidebar, .right-sidebar"), e=$(".navbar");
            a.affix( {
                offset: {
                    top: e.outerHeight()
                }
...
function() {
    ...
    Dashboard.Settings=Dashboard.Settings|| {}, Dashboard.Settings.SidebarMenuAnimationDuration=300, Dashboard.Settings.SidebarMenuAnimationEasing="", Dashboard.Sidebar= {
        setSideSubmenusMinHeight: function() {}, saveSidebarStartupClasses: function() {
            var a="", e=$("body"), n=["sidebar-slim", "sidebar-big-icons", "sidebar-overlay", "sidebar-disabled"];
            bodyClassList=e.prop("class").split(" "), bodyClassList.forEach(function(e) {
                n.indexOf(e)>=0&&(a+=e+" ")
            }
            ),
            e.data("start-sidebar-classes",
            a)
        }
        ,
        setSidebarState:function() {
            var a=$("body"), e=a.data("start-sidebar-classes");
        ...
        setupMenu:function(a) {
            function e(a) {
                ...
                "LI"===n.nodeName||"UL"===n.nodeName;
                )"UL"===n.nodeName&&e++, n=n.parentElement;
                return e
            }
            var n=a.find("li");
            n.each(function() {
                var n=$(this), t=n.find(">ul"), i=n.find(">a");
                if(t.length>0) {
                    if(n.parent()[0]===a[0]) {
                    ...
                    n.addClass("has-submenu"),
                    t.addClass("submenu-level-"+e(t[0]))
                }
            }
            )
        }
        ...
        expandMenuToCurrentLink:function() {
            var a=Dashboard.Helpers.isDefaultSidebar(), e=Dashboard.Helpers.isSidebarSlim();
            $(".sidebar .expanded").removeClass("expanded");
            for(var n=$(".sidebar .side-menu li.active"), t=n;
            "LI"==t.prop("tagName")||"UL"==t.prop("tagName");
            )"LI"==t.prop("tagName")&&((a&&!t.hasClass("side-menu")||!a&&!e&&!t.hasClass("primary-submenu"))&&t.addClass("expanded"), t.addClass("nested-active")), t=t.parent()
        }
        ,
        setMenuTooltips:function(a) {
            Dashboard.Helpers.isSidebarSlim()?a.find("> li:not(.has-submenu) a").tooltip( {
                placement: "right", container: "body", trigger: "hover"
            }
        ...
        setMenuHandler:function(e) {
            ...
            function() {
                ...
                var a=$(this), t=a.closest("li"), i=!!e.find(".velocity-animating").length;
                if(t.hasClass("primary-submenu")&&n()||i)return!1;
                var r=t.closest("ul"), o=r.find("> li > ul"), s=t.find("> ul"), d=o.filter(function() {
                    return this!==s[0]
                }
                );
                if(t.hasClass("expanded")) {
                    ...
                    ,
                    {
                        duration: Dashboard.Settings.SidebarMenuAnimationDuration, easing: Dashboard.Settings.SidebarMenuAnimationEasing, complete: function() {
                    ...
                    ,
                    {
                        display: "", duration: Dashboard.Settings.SidebarMenuAnimationDuration, easing: Dashboard.Settings.SidebarMenuAnimationEasing, complete: function() {
    ...
    Dashboard.InnerNavigator= {
        init: function(a, e) {
            ...
            var t=$(a), i=t.find("> li"), r=t.find(".active");
            i.find("ul").show().each(function() {
                $(this).data("startHeight", this.scrollHeight).css("overflow", "hidden")
            }
            ),
            r.parents("li").addClass("active expanded"),
            i.filter(":not(.expanded)").find("ul").hide(),
            i.on("click",
            function() {
                var a=$(this);
...
function() {
    window.Dashboard=window.Dashboard|| {}, Dashboard.RightSidebar= {
        setupVerticalScrolls: function() {
            function a(a) {
                var e=a.offset(), n=$(window).scrollTop(), t=a.nextAll().filter(function() {
            ...
            n=$(".right-sidebar");
            e.each(function() {
                var e=$(this), t=n.add(e.closest(".tab-pane")).add(e.closest(".right-sidebar-extra-content"));
        ...
        setupExtraContent:function() {
            function a(a, t) {
                var i=a.position().top, r=n.offset().top-e.scrollTop();
                t.css( {
                    top: i+"px", height: window.innerHeight-i-r+"px"
                }
                )
            }
            var e=$(window),
            ...
            $("[data-target-extra-content]").each(function() {
                var t=$(this), i=$("#"+t.data("targetExtraContent")), r=n.add(i.closest(".tab-pane"));
...
$(function() {
    ...
    var d= {
        dark: {
            slim:"logo-slim-{brand}@2X.png", big:"logo-big-{brand}-white@2X.png", overlay:"logo-{brand}-white@2X.png"
        }
        ,
        light: {
            slim:"logo-slim-{brand}@2X.png", big:"logo-big-{brand}-black@2X.png", overlay:"logo-{brand}-black@2X.png"
        }
        ,
        color: {
            slim:"logo-slim-{brand}@2X.png", big:"logo-big-{brand}-black@2X.png", overlay:"logo-{brand}-white@2X.png"
        }
    }
    ,
    l= {
        dark:"logo-{brand}-white@2X.png", "default":"logo-{brand}-black@2X.png", color:"logo-{brand}-white@2X.png"
    }
    ;
    window.Dashboard=window.Dashboard|| {};
    ...
    u.on("change",
    function() {
        var a=$(this), e=a.hasClass("group-switch"), n=a.is(":checked");
        if(e) {
    ...
    u.on("disabled-state-changed",
    function() {
        var a=$(this);
        a.is(":disabled")?i(a, !1): i(a, a.is(":checked"))
    }
    ),
    c.find(".action-reset-layout-options").on("click",
    function() {
    ...
    $(".navbar #sidebar-switch").on("click",
    function() {
        c.find("#layout-sidebar-style").trigger("load-handler")
    }
    ),
    c.find("#layout-sidebar-enabled").on("change",
    function(a,
    e) {
        e||c.find("#layout-content-view").trigger("change")
    }
    ),
    c.find("#layout-sidebar-style").on("load-handler",
    function() {
        var a="", e=n();
        $(this).find("option").each(function() {
            var n=this.value.split(" "), t=0;
    ...
    function() {
        ...
        b.addClass(this.value),
        o()
    }
    ).on("disabled-state-changed",
    function() {
    ...
    c.find("#layout-content-view").on("load-handler",
    function() {
    ...
    c.find("#layout-subnavbar-style").on("load-handler",
    function() {
        var a=$(this), e=a.children("option");
        e.each(function() {
    ...
    ;
    c.find("[name=mainColor],[name=navbarStyle],[name=sidebarStyle]").on("change",
    function() {
        var a=$("[name=mainColor]:checked").val(), e=$("[name=navbarStyle]:checked").val(), n=$("[name=sidebarStyle]:checked").val(), t="sidebar"+("color"===n?"-"+a: "-"+n+"-"+a), i="navbar"+("color"===e?"-"+a: "-"+e);
    ...
    function() {
        ...
        a.forEach(function(a) {
            if(a&&y.indexOf(a)>=0) {
                var e=a.split("-"), n=e[e.length-1], t=["dark", "light"].indexOf(e[1])>=0?e[1]: "color";
        ...
        $(".navigation .navbar").attr("class").split(" ").forEach(function(a) {
            if(a&&"navbar"!==a&&C.indexOf(a)>=0) {
                ...
                c.find("[name=navbarStyle][value="+e+"]").prop("checked",
                !0)
            }
        }
        ),
        S($("[name=sidebarStyle]:checked").val(),
...
function() {
    window.Dashboard=window.Dashboard|| {}, Dashboard.LayoutControl.setContentMinHeight(), Dashboard.Sidebar.expandMenuToCurrentLink(), $(function() {
        ...
        $(window).on("layout-options-changed",
        function() {
        ...
        $(".action-right-sidebar-toggle").on("click",
        function() {
        ...
        $(".action-toggle-sidebar-slim").on("click",
        function() {
            var a=$("body");
        ...
        $(".action-sidebar-open").on("click",
        function() {
            Dashboard.Sidebar.openOverlay()
        }
        ),
        $(".action-sidebar-close").on("click",
        function() {
        ...
        $(".action-toggle-layout-options").on("click",
        function() {
        ...
        $(".spin-search-box").on("click",
        function(a) {
            a.stopPropagation()
        }
        ),
        $(".spin-search-box > a").on("click",
        function() {
            return $(this).closest(".spin-search-box").toggleClass("active"), !1
        }
        ),
        Dashboard.Helpers.elementExists("#highstock-right-sidebar",
        function() {
        ...
        $("[data-radio-toggle=tab]").on("change",
        function() {
            var a=$(this).data("tabId"), e=$(".tab-pane"+a);
        ...
        function() {
            "undefined"!=typeof Holder&&(Holder.addTheme("folder", {
                bg: "#444444", fg: "#5a5a5a", font: "FontAwesome", size: 36, fontweight: "bold", text: String.fromCharCode(61716)
            }
            ),
            Holder.addTheme("video",
            {
                bg: "#444444", fg: "#2d2d2d", font: "FontAwesome", size: 36, fontweight: "normal", text: String.fromCharCode(61764)
            }
            ),
            Holder.addTheme("call",
            {
                bg: "#444444", fg: "#2d2d2d", font: "FontAwesome", size: 36, fontweight: "normal", text: String.fromCharCode(61501)
            }
            ),
            Holder.addTheme("facebook",
            {
                bg: "#3A5C96", fg: "#FFFFFF", font: "FontAwesome", size: 36, fontweight: "normal", text: String.fromCharCode(61594)
            }
            ),
            Holder.addTheme("image",
            {
                bg: "#444444", fg: "#2d2d2d", font: "FontAwesome", size: 36, fontweight: "normal", text: String.fromCharCode(61502)
            }
            ),
            Holder.addTheme("video",
            {
                bg: "#444444", fg: "#2d2d2d", font: "FontAwesome", size: 26, fontweight: "normal", text: String.fromCharCode(61501)
            }
            ),
        ...
        function() {
            ...
            Dashboard.Helpers.elementExists('[data-toggle="popover"]',
            function() {
